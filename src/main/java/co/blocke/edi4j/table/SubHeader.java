...
public class SubHeader implements BodyRow {
    private final List<Cell> cells;
    private final Style style;
    private final Align align;

    public SubHeader(List<Cell> cells) {
        this(cells, Style.SECONDARY, Align.LEFT);
    }

    public SubHeader(List<Cell> cells, Style style, Align align) {
